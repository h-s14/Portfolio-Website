    ...
    <div className="h-[85vh] px-10 xl:h-screen">
      <div className="grid sm:grid-cols-1 md:grid-cols-2">
        <div className="flex flex-col items-center justify-center sm:items-center md:items-start md:pt-20">
          <div className="relative z-40 my-8 flex h-12 w-full items-center justify-center rounded-full bg-opacity-40 md:my-7 md:h-[25%] md:max-w-[50%] lg:h-[20%]">
        ...
        <div className="mt-16 flex w-full items-center justify-center md:px-40 2xl:px-96">
          <img src="/model-light.png" className="block w-[30%] bg-transparent dark:hidden md:w-[100%]" alt="model" />
          <img src="/model-dark.png" className="hidden w-[30%] bg-transparent dark:block md:w-[100%]" alt="model" />
        </div>
      </div>
    </div>
  );
